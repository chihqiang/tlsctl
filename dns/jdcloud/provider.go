...
type Config struct {
	...
	PropagationTimeout int32  `json:"propagation_timeout,omitempty" yaml:"propagation_timeout,omitempty" xml:"propagation_timeout,omitempty" env:"JDCLOUD_PROPAGATION_TIMEOUT"`
...
func (p *Provider) NewChallengeProvider() (challenge.Provider, error) {
	...
	return jdcloud.NewDNSProviderConfig(providerConfig)
}
