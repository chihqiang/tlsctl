...
import (
	"wangzhiqiang/tlsctl/account"
	"wangzhiqiang/tlsctl/challenge"
	"wangzhiqiang/tlsctl/pkg/log"
	"wangzhiqiang/tlsctl/register"
	"wangzhiqiang/tlsctl/resource"
	"crypto/ecdsa"
	"crypto/elliptic"
	"crypto/rand"
	"path"
...
func setupClient(cmd *cli.Command, ac *account.Cache) *lego.Client {
	...
	config.UserAgent = "wangzhiqiang/tlsctl@main"
